...
var _getProperty = function _getProperty2(target, property) {
...
var _uncache = function _uncache2(animation) {
  var a = animation;
  while (a) {
    a._dirty = 1;
    a = a.parent;
...
var _postAddChecks = function _postAddChecks2(timeline2, child) {
  ...
  if (_uncache(timeline2)._dp && timeline2._initted && timeline2._time >= timeline2._dur && timeline2._ts) {
...
var _renderZeroDurationTween = function _renderZeroDurationTween2(tween, totalTime, suppressEvents, force) {
  var prevRatio = tween.ratio, ratio = totalTime < 0 || !totalTime && prevRatio && !tween._start && tween._zTime > _tinyNum && !tween._dp._lock || tween._ts < 0 || tween._dp._ts < 0 ? 0 : 1, repeatDelay = tween._rDelay, tTime = 0, pt, iteration, prevIteration;
...
var _setDuration = function _setDuration2(animation, duration, skipUncache) {
...
var _createPlugin = function _createPlugin2(config3) {
  ...
  if (config3.register) {
    config3.register(gsap, Plugin, PropTween);
  }
};
var _255 = 255;
var _colorLookup = {
...
var _ticker = function() {
  var _getTime = Date.now, _lagThreshold = 500, _adjustedLag = 33, _startTime = _getTime(), _lastUpdate = _startTime, _gap = 1 / 240, _nextTime = _gap, _listeners = [], _id, _req, _raf, _self, _tick = function _tick2(v) {
    ...
    if (tTime !== this._tTime || force || crossingStart) {
      ...
      if (this._repeat) {
        ...
        if (iteration !== prevIteration && !this._lock) {
          ...
          if (doesWrap) {
            this._lock = 2;
            prevTime = rewinding ? dur + 1e-4 : -1e-4;
